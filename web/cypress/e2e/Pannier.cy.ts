...
describe('Check Pannier', () => {
    it('Pannier change value, to be sure they are save in DB', () => {
        ...
        // vidéo => httpss://www.youtube.com/watch?v=IrWZvaFraTQ
        ...
        cy.visit('https://54.37.12.177:3000/app')
        ...
        cy.get('input[name="Num"]')
            ...
            .wait(1000).then( ()=> {
                cy.visit('https://54.37.12.177:3000/app') //reload page to be sure it save in DB
                    .wait(1000).then(() => {
                        cy.get('input[name="Num"]').first()
                    ...
                    .wait(1000).then( () => {
                        cy.visit('https://54.37.12.177:3000/app').wait(1000).then( () => { //reload page to be sure it save in DB
                            cy.get('input[name="Num"]').first()
