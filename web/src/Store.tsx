        ...
        <section>
            <div className='components'>
                <div className='componentsText'>
                    ...
                    <button
                        className='w-52 px-7 py-3 bg-white border border-gray-900 text-gray-900 hover:bg-sky-500 hover:text-white hover:border-sky-500 hover:ring-4 hover:ring-sky-200 transition duration-500 rounded-full text-center'
                        onClick={openGoogleMapsBrussel}>GO
                        TO
                    </button>
                </div>
            ...
            <div className='components'>
                ...
                <div className='componentsText'>
                    ...
                    <div onClick={() => handleClick("Spilstraat 11, 6211 CN Maastricht, Netherlands")}>
                        <div className="buttonAddress" style={{display: 'flex'}}>Spilstraat 11, 6211 CN Maastricht,
                            Netherlands
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                 style={{margin: '0 0 0 10px'}} viewBox="0 0 16 16">
                                <path fillRule="evenodd"
            ...
            <div className='components'>
                <div className='componentsText'>
                    ...
                    <button
                        className='w-52 px-7 py-3 bg-white border border-gray-900 text-gray-900 hover:bg-sky-500 hover:text-white hover:border-sky-500 hover:ring-4 hover:ring-sky-200 transition duration-500 rounded-full text-center'
                        onClick={openGoogleMapsLiege}>GO
                        TO
                    </button>
                </div>
                <div className="google-map componentsImage">
