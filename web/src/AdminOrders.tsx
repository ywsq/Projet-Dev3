...
function AdminOrders() {
    ...
    const handleClickGetData = async (ID_Order: number) => {
        try {
            const response = await axios.get(`API/cart/admin/${ID_Order}`);
                                ...
                                <div className="flex justify-center w-10">
                                    <button className="group">
                                        ...
                                        <div
                                            ...
                                            <hr/>
                                            <button onClick={() => handleClickView(index, item.ID_Orders)}
                                                    className="block hover:bg-gray-100 w-full p-1">
                                                View
                                            </button>
                                        </div>
                                ...
                                <div className="w-full flex flex-col items-center  px-10 py-5">
                                    <div className="w-1/2 bg-white rounded-xl p-5 border shadow-lg">
                                        ...
                                        <details className="w-full rounded-xl px-4 hover:bg-gray-100">
                                            ...
                                            <hr/>
                                            <div className="py-4">
                                                <button onClick={() => handleClickDeleteData(item.ID_Orders)}>Delete
                                                </button>
                                            </div>
                                        </details>
                                        {expandedEdit[index] && (item.Status === "in review") && (
                                            <details className="w-full rounded-xl px-4 hover:bg-gray-100">
                                                ...
                                                <div className="py-4">
                                                    <button
                                                        onClick={() => handleClickCancelData(item.ID_Orders)}>Cancel
                                                    </button>
                                                </div>
                                            </details>
                                        )}
                                        {expandedEdit[index] && (item.Status === "cancel") && (
                                            <details className="w-full rounded-xl px-4 hover:bg-gray-100">
                                                ...
                                                <div className="py-4">
                                                    <button
                                                        onClick={() => handleClickUnCancelData(item.ID_Orders)}>UnCancel
                                                    </button>
                                                </div>
                                            </details>
                                        )}
