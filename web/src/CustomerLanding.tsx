...
function CustomerLanding() {
    ...
    return (
        <div className="w-full">
            <div id="categories" className="flex w-full h-[600px] px-4 py-14 items-center justify-center space-x-10 bg-gradient-to-t from-[#f6f6f6] to-sky-200">
                <Link to="/Products" className="hover:scale-105 duration-200 flex flex-col items-center h-96 w-1/3 rounded-2xl shadow-lg">
                    <img
            ...
            <div className="flex px-4 py-14 space-y-4 xl:space-y-12 xl:px-24">
                <div className='flex shadow-lg'>
                    <div className="flex flex-col space-y-4 items-center justify-center w-1/3 text-center p-4 bg-gradient-to-b from-[#f5f5f5] to-[#e5e5e5]">
                        <h1 className="text-4xl font-bold">Fequently asked<br/><span className="text-sky-500">Questions</span>.</h1>
                        <h2 className="text-xl">Find answer in this section</h2>
                        <button className='w-52 px-7 py-3 bg-sky-500 text-white hover:bg-sky-500 hover:text-white hover:ring-8 hover:ring-sky-200 transition duration-500 rounded-full text-center'>Find</button>
                    </div>
                    <img
