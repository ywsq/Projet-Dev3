                    ...
                    <div
                        ...
                        <div className="max-w-md w-full space-y-8">
                            <div className="text-center">
                                ...
                                <p className="mt-5 text-sm font-semibold text-gray-500">The only access to the entire catalog and exclusive features</p>
                            </div>
                            <form className="mt-8 space-y-6" action="#" method="POST">
                                ...
                                <div className="grid grid-cols-2 space-x-2">
                                    ...
                                    <p className="flex flex-col items-center justify-center mt-10 text-center text-md text-gray-500">
                                        ...
                                        <a href="/Login"
                                           className="text-sky-300 hover:text-blue-500 no-underline hover:underline cursor-pointer transition ease-in duration-300">Log in with your account</a>
                                    </p>
                            </form>
                        </div>
                    </div>
